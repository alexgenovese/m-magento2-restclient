...
module.exports = function (restClient) {
    ...
    module.list = function (searchCriteria) {
        return restClient.get(util.format('/orders?%s', searchCriteria));
    }

    module.getTotalOrders = function () {
        return restClient.get('/orders/?searchCriteria[filter_groups][0][filters][0][field]=status&searchCriteria[filter_groups][0][filters][0][value]=pending&searchCriteria[page_size]=1&searchCriteria[current_page]=0');
    }
