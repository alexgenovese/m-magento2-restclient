...
module.exports = function (restClient) {
    ...
    module.searchBySku = function( sku ) {
        return restClient.get('/search?searchCriteria[requestName]=advanced_search_container&searchCriteria[filter_groups][0][filters][0][field]='+sku);
    }
